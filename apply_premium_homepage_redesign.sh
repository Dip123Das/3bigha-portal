...
if [ ! -f "app/page.tsx" ]; then
  echo "ERROR: app/page.tsx not found. Run this from your 3bigha-portal root folder."
  exit 1
fi
...
echo "Premium homepage redesign applied to app/page.tsx"
echo "Now run:"
echo "  npm run build"
echo "  git diff -- app/page.tsx"
echo "  git add app/page.tsx && git commit -m 'Redesign homepage as premium marketplace landing page' && git push origin main"
