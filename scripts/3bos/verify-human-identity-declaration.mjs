...
const checks = [
  ...
  ["West Bengal surveyor alias", declaration.includes('return `${standard} (Amin)`')],
  ["dignified skilled-work labels", registry.includes('label: "Masonry Professional"') && registry.includes('label: "Electrical Technician"')],
