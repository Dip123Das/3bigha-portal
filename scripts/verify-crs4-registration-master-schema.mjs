...
const required = [
  ...
  "'manufacturer', 'construction_infrastructure'",
  "'builder_developer', 'property'",
  "'architect', 'professional_services'",
  "'surveyor', 'professional_services'",
  "'technician', 'professional_services'",
  "'equipment_owner', 'equipment_logistics'",
  "'bank', 'finance'",
  "'factory', 'manufacturing_industry'",
  "'farmer', 'agriculture'",
  "'water_supplier', 'utilities'",
  "'blogger', 'media_digital'",
  "'startup', 'others'",
