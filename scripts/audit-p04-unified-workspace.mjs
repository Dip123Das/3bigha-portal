...
const checks = [
  ...
  ["multi-business cards represent every resolved workspace", page.includes("representativeActions") && page.includes("candidate.workspaceKey === action.workspaceKey")],
  ["additional actions remain human disclosed", page.includes("disclosedActions") && page.includes("Show {disclosedActions.length} more")],
