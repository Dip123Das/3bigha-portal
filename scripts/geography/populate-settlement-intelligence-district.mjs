...
if (!districtCode) {
  console.error("Usage: node scripts/geography/populate-settlement-intelligence-district.mjs <lgd-district-code>");
  process.exit(1);
}
...
where s.is_active = true
  and s.lgd_district_code = ${Number(districtCode)}
...
console.log(`Settlement intelligence populated for district code ${districtCode}`);
