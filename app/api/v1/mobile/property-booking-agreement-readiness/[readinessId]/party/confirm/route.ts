...
import {
  mobileFailure,
  mobileSuccess,
  type MobilePropertyBookingAgreementPartyConfirmation,
  ...
  try {
    ...
    const body =
      (await request.json().catch(() => ({}))) as
        Partial<MobilePropertyBookingAgreementPartyConfirmation>;
    ...
    const workspace =
      await confirmMobilePropertyBookingAgreementPartyInput({
