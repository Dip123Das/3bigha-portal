    ...
    <main>
      <Container>
        ...
        <ErpPanel
          ...
          subtitle="Start here. These are the real daily work areas for a vendor."
          tone="blue"
        >
          <ErpKpiGrid>
            <ErpKpiCard label="New Leads" value={leadStats.newLeadCount} helper="Buyer opportunities" tone="blue" />
            <ErpKpiCard label="Messages" value={unreadNotificationCount} helper="Unread alerts" tone={unreadNotificationCount > 0 ? "red" : "green"} />
            <ErpKpiCard label="Reply Rate" value={`${replyRate}%`} helper={vendorResponseGrade} tone={replyRate >= 55 ? "green" : "orange"} />
            <ErpKpiCard label="Ready Deals" value={dealStats.ready} helper={`${dealStats.total} tracked signals`} tone="violet" />
          </ErpKpiGrid>

          <ErpActionGrid>
            {uniqueVendorCapabilities.includes("property_owner") ? (
              <ErpActionCard title="Property" description="Manage property listings." href="/property/my" tone="blue" />
            ) : null}

            {uniqueVendorCapabilities.includes("property_builder") ? (
              <ErpActionCard title="Builder Projects" description="Manage builder projects and units." href="/property/builder/projects" tone="blue" />
            ) : null}
            ...
            {uniqueVendorCapabilities.includes("rentals") ? (
              <ErpActionCard title="Rentals" description="Manage rental listings and availability." href="/rentals/my" tone="violet" />
            ) : null}

            <ErpActionCard title="RFQs / Buyer Leads" description="Open buyer enquiries and pending RFQs." href="/dashboard/vendor/enquiries" tone="blue" />
            <ErpActionCard title="Messages" description="Open buyer conversations." href="/dashboard/inbox-v2" tone="green" />
            <ErpActionCard title="Inventory" description="Open stock and inventory operations." href="/dashboard/vendor/inventory" tone="green" />
            <ErpActionCard title="Billing" description="Create invoice and bill." href="/dashboard/vendor/billing" tone="orange" />
            <ErpActionCard title="Fleet" description="Manage vehicles and delivery capacity." href="/dashboard/vendor/fleet" tone="violet" />
            <ErpActionCard title="Dispatch" description="Create delivery and dispatch workflow." href="/dashboard/vendor/dispatch" tone="blue" />
          </ErpActionGrid>
        </ErpPanel>

        <ErpPanel
          title="Today’s Action Centre"
          subtitle="Only the important things that need attention today."
          tone="green"
        >
          <ErpAlertList
            alerts={[
              {
                label:
                  missedLeads > 0
                    ...
                    : "No urgent buyer follow-up pending.",
                tone: missedLeads > 0 ? "orange" : "green",
              },
              {
                label:
                  dealStats.ready > 0
                    ? `${dealStats.ready} conversations are ready for closing.`
          ...
          <ErpActionGrid>
            <ErpActionCard title="Reply to Buyers" description="Handle today’s leads first." href="/dashboard/vendor/enquiries" tone="blue" />
            <ErpActionCard title="Open Inbox" description="Continue buyer conversations." href="/dashboard/inbox-v2" tone="green" />
            <ErpActionCard title="Notifications" description="Review vendor alerts." href="/dashboard/vendor/notifications" tone="orange" />
          </ErpActionGrid>
        </ErpPanel>

        <ErpPanel
          title="Business Management"
          subtitle="Settings, profile, content and growth controls."
          tone="orange"
        >
          <ErpKpiGrid>
            <ErpKpiCard label="Profile" value={vendorComplete === true ? "Complete" : "Pending"} helper={vendorPct !== null ? `${vendorPct}% completed` : "Business profile"} tone={vendorComplete === true ? "green" : "orange"} />
            <ErpKpiCard label="Plan" value={vendorPlan.replace(/_/g, " ").toUpperCase()} helper={vendorStatus.toUpperCase()} tone="blue" />
            <ErpKpiCard label="Vendor Rank" value={`#${estimatedRank}`} helper={rankLabel} tone={estimatedRank <= 5 ? "green" : "red"} />
          ...
          <ErpActionGrid>
            ...
            {uniqueVendorCapabilities.includes("blog_author") ? (
              <ErpActionCard title="Blog / News" description="Manage business posts and updates." href="/blog/my" tone="blue" />
            ) : null}

            <ErpActionCard title="Subscription" description="Manage vendor plan." href="/dashboard/subscription" tone="blue" />
            <ErpActionCard title="Boost Visibility" description="Improve buyer discovery rank." href="/dashboard/subscription/boost" tone="orange" />
          </ErpActionGrid>
        </ErpPanel>
        ...
        <div style={{ marginTop: 16, opacity: 0.75, fontSize: 13 }}>
          Clean vendor dashboard: real work first, AI tools below, repeated old sections removed.
        </div>
      </Container>
    </main>
  );
