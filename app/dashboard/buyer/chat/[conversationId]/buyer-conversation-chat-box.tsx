...
const DealScoreClient = nextDynamic(
  () => import("@/app/components/ai/DealScoreClient"),
  { ssr: false }
);
const DealReadyClient = nextDynamic(
  () => import("@/app/components/ai/DealReadyClient"),
  { ssr: false }
);
...
const StickyWorkflowCommandBar = nextDynamic(
  () => import("@/components/operational/StickyWorkflowCommandBar"),
  { ssr: false }
);
import {
