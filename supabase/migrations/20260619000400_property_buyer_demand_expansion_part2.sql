-- Additional property SEO mass expansion superseded by controlled SEO architecture.
--
...
do $$
begin
  raise notice 'Additional property SEO mass expansion superseded by controlled SEO architecture.';
end
$$;
